...
var SCREENSHOT_DIR = '/Users/zero-suminc./Desktop/ZS-MAC/zero-sum-nutrition/apps/web/verification';
var BASE_URL = 'http://127.0.0.1:3101';
...
(async () => {
  ...
  try {
    ...
    await page.screenshot({
      path: path.join(SCREENSHOT_DIR, '01-signup-form.png'),
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: path.join(SCREENSHOT_DIR, '02-verify-step.png'),
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: path.join(SCREENSHOT_DIR, '03-onboarding-page.png'),
      fullPage: true,
    });
    ...
    check(
      ...
      'URL contains /onboarding (actual: ' + currentUrl + ')'
    );
