...
async function testFeature270() {
  ...
  // Take screenshot
  await page2.screenshot({ path: '/tmp/feature-270-step4-dashboard-after-reopen.png', fullPage: true });
  ...
  const dashboardLoaded = await page2.evaluate(() => {
    ...
    const hasContent = document.body.textContent.includes('Welcome') ||
