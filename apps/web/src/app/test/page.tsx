...
export default function TestPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#fafafa] p-8">
      ...
      <p className="text-[#a1a1aa] mb-8">Plan generation creates BullMQ job</p>
      ...
      <div className="space-y-6">
        ...
        <div>
          <button
            ...
            disabled={loading}
            className="px-6 py-3 bg-[#f97316] text-white font-bold rounded-lg hover:bg-[#ea580c] disabled:opacity-50 transition-colors"
          >
        ...
        {result && (
          <div
            className={`p-6 rounded-lg border ${
              result.success ? 'bg-[#1a1a1a] border-[#22c55e]' : 'bg-[#1a1a1a] border-[#ef4444]'
            }`}
          >
            ...
            {result.error && <p className="text-[#ef4444] mb-4">Error: {result.error}</p>}
            ...
            {result.verification && (
              <div className="space-y-2 font-mono text-sm">
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      result.verification.jobIdReturned ? 'text-[#22c55e]' : 'text-[#ef4444]'
                    }
                  >
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      result.verification.dbRecordCreated ? 'text-[#22c55e]' : 'text-[#ef4444]'
                    }
                  >
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      result.verification.dbStatus === 'pending'
                        ? 'text-[#22c55e]'
                        : 'text-[#ef4444]'
                    }
                  >
                    {result.verification.dbStatus === 'pending' ? '✓ YES' : '✗ NO'} (
                    {result.verification.dbStatus})
                  </span>
                </div>
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      result.verification.bullmqEnqueued ? 'text-[#22c55e]' : 'text-[#ef4444]'
                    }
                  >
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      result.verification.fastResponse ? 'text-[#22c55e]' : 'text-[#f59e0b]'
                    }
                  >
                    {result.verification.responseTimeMs}ms{' '}
                    {result.verification.fastResponse ? '(fast ✓)' : '(slow ⚠)'}
                  </span>
                </div>
              </div>
            )}
