        ...
        <main id="main-content">
          ...
          <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12 lg:py-28">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-12">
              ...
              {/* Snap & Track (small) */}
              <div className="rounded-2xl border border-border bg-card p-6 transition-all duration-300 hover:border-primary/30 sm:col-span-4">
            ...
            <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 sm:px-8 lg:grid-cols-2 lg:px-12 lg:py-28">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div
                    key={item.title}
                    className="border-l-2 border-primary/30 pl-6 transition-colors duration-300 hover:border-primary"
                  >
