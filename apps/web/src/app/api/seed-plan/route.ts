        ...
        meals: [
          {
            ...
            ingredients: [
              { name: 'Greek yogurt', amount: 200, unit: 'g', fatsecretFoodId: '11111' },
              { name: 'Whey protein powder', amount: 30, unit: 'g', fatsecretFoodId: '22222' },
              { name: 'Mixed berries (strawberries, blueberries)', amount: 100, unit: 'g', fatsecretFoodId: '33333' },
              { name: 'Granola (low sugar)', amount: 30, unit: 'g', fatsecretFoodId: '44444' },
              { name: 'Honey (drizzle)', amount: 1, unit: 'tbsp', fatsecretFoodId: '55555' },
            ],
          ...
          },
          {
            ...
            confidenceLevel: 'verified',
            ingredients: [
              { name: 'Chicken breast (skinless, cooked)', amount: 200, unit: 'g', fatsecretFoodId: '66666' },
              { name: 'Quinoa (dry, uncooked)', amount: 100, unit: 'g', fatsecretFoodId: '77777' },
              { name: 'Mixed salad greens (spinach, arugula)', amount: 100, unit: 'g', fatsecretFoodId: '88888' },
              { name: 'Cherry tomatoes', amount: 80, unit: 'g', fatsecretFoodId: '99999' },
              { name: 'Extra virgin olive oil', amount: 15, unit: 'ml', fatsecretFoodId: '10101' },
              { name: 'Lemon juice (fresh)', amount: 1, unit: 'tbsp', fatsecretFoodId: '10202' },
            ],
          ...
          },
          {
            ...
            confidenceLevel: 'verified',
            ingredients: [
              { name: 'Atlantic salmon fillet', amount: 200, unit: 'g', fatsecretFoodId: '10303' },
              { name: 'Broccoli florets (steamed)', amount: 150, unit: 'g', fatsecretFoodId: '10404' },
              { name: 'Sweet potato (baked)', amount: 150, unit: 'g', fatsecretFoodId: '10505' },
              { name: 'Extra virgin olive oil', amount: 1, unit: 'tbsp', fatsecretFoodId: '10606' },
              { name: 'Garlic powder', amount: 0.5, unit: 'tsp', fatsecretFoodId: '10707' },
              { name: 'Fresh dill', amount: 1, unit: 'tbsp', fatsecretFoodId: '10808' },
            ],
          ...
          },
          {
            ...
            ingredients: [
              { name: 'Whey protein powder (chocolate)', amount: 45, unit: 'g', fatsecretFoodId: '10909' },
              { name: 'Almond milk (unsweetened)', amount: 300, unit: 'ml', fatsecretFoodId: '11010' },
              { name: 'Raw almonds', amount: 20, unit: 'g', fatsecretFoodId: '11111' },
              { name: 'Banana (sliced)', amount: 80, unit: 'g', fatsecretFoodId: '11212' },
            ],
