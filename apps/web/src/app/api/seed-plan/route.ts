      ...
      days: Array.from({ length: 7 }, (_, i) => ({
        ...
        meals: [
          ...
          },
          {
            slot: 'lunch',
            name:
              i + 1 === todayDayNumber ? 'Grilled Chicken & Quinoa Salad' : `Day ${i + 1} Lunch`,
          ...
          },
          {
            slot: 'dinner',
            name:
              i + 1 === todayDayNumber ? 'Salmon with Roasted Vegetables' : `Day ${i + 1} Dinner`,
            cuisine: 'american',
            prepTimeMin: 10,
            cookTimeMin: 25,
      ...
      groceryList: [
        {
          category: 'Produce',
          items: [
            { name: 'Mixed greens', amount: '700g' },
            { name: 'Broccoli', amount: '1050g' },
          ],
        },
        {
          category: 'Meat and Seafood',
          items: [
            { name: 'Chicken breast', amount: '1400g' },
            { name: 'Salmon fillet', amount: '1400g' },
          ],
        },
        { category: 'Dairy and Eggs', items: [{ name: 'Greek yogurt', amount: '1400g' }] },
      ],
