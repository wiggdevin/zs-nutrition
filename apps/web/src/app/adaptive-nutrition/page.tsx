          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 bg-card border border-border rounded-xl p-6">
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                <p>
                  <strong className="text-foreground">1. Log Weekly:</strong> Record your weight at least once per
                  week, ideally at the same time of day (e.g., Monday mornings, fasted).
                </p>
                <p>
                  <strong className="text-foreground">2. Track Progress:</strong> The system analyzes your weight
                  trend and compares it to your goal rate (e.g., 0.5-1 lb/week for cutting).
                </p>
                <p>
                  <strong className="text-foreground">3. Get Suggestions:</strong> If you deviate from your target
                  rate, the system will suggest calorie adjustments to get you back on track.
                </p>
                <p>
                  <strong className="text-foreground">4. Stay Safe:</strong> All adjustments are kept within safe
                  bounds (BMR + 200 to BMR + 1500) to ensure healthy metabolic function.
                </p>
                <p>
                  <strong className="text-foreground">5. Prevent Plateaus:</strong> Gradual calorie adjustments help
