    ...
    <div className="min-h-screen bg-background text-foreground p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="bg-card rounded-lg p-6 border border-border">
          ...
          <p className="text-muted-foreground mb-4">Onboarding training days multi-select works</p>

          <div className="bg-background rounded p-4 mb-6">
            <h2 className="text-sm font-mono uppercase tracking-wider text-primary mb-3">
              Test Steps
            </h2>
            <ol className="space-y-2 text-sm">
              <li className={data.trainingDays.includes("monday") ? "text-green-500" : "text-muted-foreground"}>
                1. Click Monday - verify selected {data.trainingDays.includes("monday") ? "✅" : "⬜"}
              </li>
              <li className={data.trainingDays.includes("wednesday") ? "text-green-500" : "text-muted-foreground"}>
                2. Click Wednesday - verify selected {data.trainingDays.includes("wednesday") ? "✅" : "⬜"}
              </li>
              <li className={data.trainingDays.includes("friday") ? "text-green-500" : "text-muted-foreground"}>
              ...
              <li className={data.trainingDays.length === 2 && !data.trainingDays.includes("monday") ? "text-green-500" : "text-muted-foreground"}>
          ...
          <div className="bg-background rounded p-4">
            ...
            <div className="mt-2 text-sm">
              ...
              <span className="text-primary font-bold">{data.trainingDays.length}</span>
              <span className="text-muted-foreground ml-4">Days: </span>
