  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] p-8 text-[#fafafa]">
      <div className="mx-auto max-w-2xl">
        <h1 className="text-2xl font-black uppercase tracking-wider">Feature #153 Test</h1>
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="rounded-lg border border-[#2a2a2a] bg-[#1a1a1a] p-6">
            <h2 className="text-sm font-bold uppercase text-[#f97316]">Verification Steps</h2>
            <ul className="mt-3 space-y-2 text-sm text-[#a1a1aa]">
              ...
              <li>
                ✅ Verify PlanGenerationJob record created in DB with status &apos;pending&apos;
              </li>
          ...
          <button
            onClick={runTest}
            disabled={loading}
            className="w-full rounded-lg bg-[#f97316] px-6 py-4 text-sm font-black uppercase tracking-wider text-white transition-colors hover:bg-[#ea580c] disabled:opacity-50"
          >
              ...
              {result.success && result.verification && (
                <div className="mt-4 space-y-2 font-mono text-xs">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={
                        result.verification.fastResponse ? 'text-[#22c55e]' : 'text-[#ef4444]'
                      }
                    >
