  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-8">
      <div className="max-w-2xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">Tailwind CSS + shadcn/ui Test</h1>
        ...
        <p className="text-xs text-muted-foreground font-mono">STATUS: ALL SYSTEMS OPERATIONAL</p>
      </div>
    </div>
  );
}
