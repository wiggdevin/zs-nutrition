  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#fafafa] p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-2 text-[#f97316]">Feature #139 Test</h1>
        <h2 className="text-xl mb-6 text-[#a1a1aa]">Meal Swap Max 3 Retry Attempts</h2>

        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-6 mb-6">
          <h3 className="text-lg font-semibold mb-4">Test Configuration</h3>
          <ul className="list-disc list-inside space-y-2 text-sm">
            <li>Max Retries: <span className="text-[#f97316] font-mono">3</span></li>
            <li>Retry Delay: <span className="text-[#f97316] font-mono">1000ms (1 second)</span></li>
            <li>Test Endpoint: <span className="text-[#f97316] font-mono">/api/plan/swap-fail-test</span> (intentionally fails)</li>
          </ul>
        </div>
        ...
        <div className="flex gap-4 mb-6">
          <button
            ...
            disabled={isRunning}
            className="px-6 py-3 bg-[#f97316] hover:bg-[#ea580c] disabled:bg-[#2a2a2a] disabled:text-[#a1a1aa] disabled:cursor-not-allowed rounded-lg font-semibold transition-colors"
          >
          ...
          <button
            ...
            className="px-6 py-3 bg-[#2a2a2a] hover:bg-[#3a3a3a] disabled:bg-[#1a1a1a] disabled:text-[#a1a1aa] disabled:cursor-not-allowed rounded-lg font-semibold transition-colors"
          >
            Clear Results
          </button>
        </div>
            ...
            <div className="space-y-3">
              {testResults.map((result, idx) => (
                ...
                >
                  ...
                  {result.error && (
                    <div className="mt-2 text-sm text-[#ef4444] font-mono">
                      Error: {result.error}
                    </div>
                  )}
                </div>
            ...
            <div className="mt-6 p-4 bg-[#0a0a0a] border border-[#2a2a2a] rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-[#ef4444]">Meal Swap Failed</p>
        ...
        <div className="mt-8 bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-6">
          ...
          <ol className="list-decimal list-inside space-y-3 text-sm">
            <li
              className={testResults.length >= 1 ? "text-[#22c55e] line-through" : ""}
            >
              Trigger a meal swap in conditions likely to fail
              {testResults.length >= 1 && <span className="ml-2">✅</span>}
            </li>
            <li
              className={testResults.length >= 3 ? "text-[#22c55e] line-through" : ""}
            >
        ...
        <div className="mt-8 bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-6">
          ...
          <div className="space-y-4 text-sm">
            <div>
              <div className="font-mono text-[#a1a1aa] mb-1">File:</div>
              <div className="text-[#fafafa]">
                zero-sum-nutrition/apps/web/src/app/meal-plan/page.tsx
              </div>
            </div>
            <div>
              <div className="font-mono text-[#a1a1aa] mb-1">Function:</div>
              <div className="text-[#fafafa]">handleSwapSelect (lines 923-1019)</div>
            </div>
            <div>
              <div className="font-mono text-[#a1a1aa] mb-1">Constants:</div>
            ...
            <div>
              <div className="font-mono text-[#a1a1aa] mb-1">Error Message:</div>
              <div className="text-[#fafafa]">
                &quot;Failed to swap meal after 3 attempts. Please try again.&quot;
              </div>
            </div>
