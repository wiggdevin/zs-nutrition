...
export default async function HomePage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-gradient-to-b from-[#0a0a0a] to-[#121212]">
      {/* Header / Nav */}
      <header className="flex items-center justify-between px-6 py-4 sm:px-8 lg:px-12">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold uppercase tracking-wide text-[#fafafa]">
            ZS-<span className="text-[#f97316]">MAC</span>
          </span>
        </div>
        <nav className="flex items-center gap-3">
          <Link
            href="/sign-in"
            className="rounded-lg px-4 py-2 text-sm font-medium text-[#a1a1aa] transition-colors hover:text-[#fafafa]"
          >
            Sign In
          </Link>
          <Link
            href="/sign-up"
            className="rounded-lg bg-[#f97316] px-4 py-2 text-sm font-medium text-[#0a0a0a] transition-colors hover:bg-[#ea580c]"
          >
            Get Started
          </Link>
        </nav>
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 text-center">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mb-8 flex justify-center">
            <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-[#f97316] to-[#ea580c] shadow-lg shadow-[#f97316]/20">
              <span className="text-2xl font-bold text-white">ZS</span>
            </div>
          </div>

          {/* Headline */}
          <h1 className="text-4xl font-heading uppercase tracking-tight text-[#fafafa] sm:text-5xl lg:text-6xl">
            Zero Sum{' '}
            <span className="text-[#f97316]">Nutrition</span>
          </h1>

          {/* Subtitle */}
          <p className="mt-4 text-lg text-[#a1a1aa] sm:text-xl lg:text-2xl">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/sign-up"
              className="w-full rounded-xl bg-[#f97316] px-8 py-3.5 text-base font-semibold text-[#0a0a0a] shadow-lg shadow-[#f97316]/25 transition-all hover:bg-[#ea580c] hover:shadow-[#f97316]/40 sm:w-auto"
            >
              Start Free Plan
            </Link>
            <Link
              href="/sign-in"
              className="w-full rounded-xl border border-[#2a2a2a] bg-[#1a1a1a] px-8 py-3.5 text-base font-semibold text-[#fafafa] transition-all hover:border-[#3a3a3a] hover:bg-[#222222] sm:w-auto"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="mt-20 grid max-w-4xl grid-cols-1 gap-6 sm:grid-cols-3">
          <div className="rounded-xl border border-[#2a2a2a] bg-[#1a1a1a]/50 p-6 text-center">
            <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-[#f97316]/10">
              <svg className="h-5 w-5 text-[#f97316]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
