    ...
    <div data-testid="goals-section">
        ...
        <div>
          ...
          <div className="space-y-2">
            {(['cut', 'maintain', 'bulk'] as GoalType[]).map((goal) => (
              ...
              >
                <span
                  className={`block text-sm font-bold uppercase tracking-wide ${goalType === goal ? 'text-primary' : 'text-foreground'}`}
                >
                  {goal}
                </span>
      ...
      {success && (
        <div
          ...
          data-testid="goals-save-success"
        >
          <svg
