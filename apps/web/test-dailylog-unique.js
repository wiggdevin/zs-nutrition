...
process.env.DATABASE_URL =
  'file:/Users/zero-suminc./Desktop/ZS-MAC/zero-sum-nutrition/apps/web/dev.db';
...
async function testDailyLogUniqueConstraint() {
  ...
  try {
    ...
    if (
      ...
      console.log(
        '    Actual: kcal=' +
          finalDailyLog.actualKcal +
          ', protein=' +
          finalDailyLog.actualProteinG +
          ', carbs=' +
          finalDailyLog.actualCarbsG +
          ', fat=' +
          finalDailyLog.actualFatG
      );
      return false;
    }
