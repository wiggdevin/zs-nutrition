...
console.log('Input:', JSON.stringify({ heightFeet: input.heightFeet, heightInches: input.heightInches, weightLbs: input.weightLbs }, null, 2));
...
try {
  ...
  console.log(`✅ Test 2: weightKg = ${result.weightKg} (expected ~${expectedWeight}) - ${weightPass ? 'PASS' : 'FAIL'}`);
  ...
  console.log(`✅ Test 3: No imperial fields in output - heightFeet: ${hasHeightFeet}, heightInches: ${hasHeightInches}, weightLbs: ${hasWeightLbs} - ${noImperial ? 'PASS' : 'FAIL'}`);
