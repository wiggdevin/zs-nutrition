...
import { GOOGLE_FONTS_LINK } from './brand-constants';
...
export async function renderPdf(
  ...
  try {
    ...
    await page.setContent(combinedHtml, { waitUntil: 'networkidle0', timeout: 15000 });
    ...
    const pdfBuffer = await page.pdf({
      ...
      footerTemplate: `
        <div style="width:100%;font-size:9px;padding:0 15mm;display:flex;justify-content:space-between;align-items:center;color:#64748b;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
          <span>Generated by Zero Sum Nutrition &bull; zerosumnutrition.com</span>
